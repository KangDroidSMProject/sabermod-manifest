...
Only supported linux is Ubuntu 14.04 (Trusty).
...
Linux x86_64 - This source only has been tested and works on linux 64bit systems.  Tested on Ubuntu 14.04 (Trusty).
